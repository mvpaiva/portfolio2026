...
// Body re-synced 2026-09-17 (Matheus dropped the "O briefing:" lead-in
// and "de verdade").
    ...
    <CaseSection id="contexto">
      ...
      >
        <p className={styles.body}>
          Transformar o Register em autoatendimento, lançar um app
          complementar que apoie a jornada inteira (não só o pagamento),
          manter o fluxo utilizável por qualquer idade ou perfil sem exigir
          assistência, e manter todo item rastreável. Este case acompanha a
          fase entre pegar o primeiro item e sair pela porta. Projeto solo,
          sem afiliação oficial com a Square.
        </p>
      </BlockGrid>
    </CaseSection>
  );
