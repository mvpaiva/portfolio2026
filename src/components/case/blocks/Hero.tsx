...
export function Hero() {
  return (
    <header className={styles.section}>
      <div className={`${styles.content} ${liftStyles.item}`}>
        <p className={styles.eyebrow}>Estudo de caso</p>
        <h1 className={styles.headline}>Pulando a fila do caixa.</h1>
        <p className={styles.subhead}>
          Um redesign de 6 meses do autoatendimento do Square Register e de
          um app complementar, do estacionamento até o portão de saída.
        </p>
